...
specify preset add --from https://github.com/ynny-github/spec-kit-preset/archive/refs/tags/v1.0.0.zip

# Or from main branch
specify preset add --from https://github.com/ynny-github/spec-kit-preset/archive/refs/heads/main.zip
```
...
specify init --here --integration claude \
  --preset https://github.com/ynny-github/spec-kit-preset/archive/refs/heads/main.zip
```
...
specify preset add --from https://github.com/ynny-github/spec-kit-preset/archive/refs/tags/v1.1.0.zip
```
